...
while ($date != $today){
    ...
    if (-e "/var/jsi/apama/logfiles/apamalogs_2009${tstamp}.tar.bz2") {
        ...
        system("cat /var/jsi/atalogs/*correlator_${date}* | grep OrderUpdate | perl process_fills.pl > trades_${date}.csv");
    }
